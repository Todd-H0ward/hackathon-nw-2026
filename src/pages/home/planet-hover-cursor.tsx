...
import { getPlanetInfo } from './planet-info.stubs';
...
export const PlanetHoverCursor = forwardRef<PlanetHoverCursorHandle>(
  function PlanetHoverCursor(_, ref) {
    ...
    const place = (clientX: number, clientY: number) => {
      ...
      if (!el) return;
      // Pure CSS transform — no React render on move.
    ...
    const info = body ? getPlanetInfo(body) : null;
